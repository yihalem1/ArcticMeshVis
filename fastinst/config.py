...
def add_fastinst_config(cfg):
    ...
    cfg.MODEL.FASTINST.HAND_KEYP_WEIGHT = 5
    cfg.MODEL.FASTINST.OBJ_KEYP_WEIGHT = 5
    cfg.MODEL.FASTINST.DELTA_HAND_WEIGHT = 2.5
    cfg.MODEL.FASTINST.DELTA_OBJ_WEIGHT = 2.5
    # transformer config
    ...
    cfg.MODEL.FASTINST.NUM_CONTACT_QUERIES = 0
